...
export const RecoveryPhraseDisplay: React.FC<RecoveryPhraseDisplayProps> = ({ mnemonic, onSaved }) => {
  ...
  return (
    <div className="flex h-screen flex-col items-center justify-center p-6 bg-background">
      <div className="w-full max-w-sm bg-surface-container-high border border-outline-variant rounded-3xl p-8 shadow-2xl">
        ...
        <div className="bg-surface-container-lowest border border-outline-variant rounded-xl p-4 text-sm font-mono text-center mb-8 break-words text-white select-all">
          {mnemonic}
        </div>
        <button
          onClick={async () => {
