...
import { Network, Eye, EyeOff, Plus, Trash2, Shield, Copy, Edit2, Check, X, RefreshCcw } from 'lucide-react';
...
export const NostrSection: React.FC = () => {
  ...
  return (
    <div className="bg-surface-container-low rounded-2xl p-4 md:p-6 mb-6 border border-outline-variant/20 shadow-sm relative overflow-hidden group">
      ...
      <div className="space-y-4 relative z-10">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 relative">
            <input
              ...
              readOnly
              className="w-full bg-surface-container-high border border-outline-variant/30 rounded-xl px-4 py-3 text-body-md text-on-surface font-mono text-sm focus:outline-none pr-12"
            />
            <button
          ...
          {isEditingNsec ? (
            <div className="flex items-center gap-2">
              <input
                ...
                value={editNsecValue}
                onChange={(e) => setEditNsecValue(e.target.value)}
                autoFocus
                className="flex-1 min-w-0 bg-surface-container-highest border border-primary/50 rounded-xl px-4 py-3 text-body-md text-on-surface font-mono text-sm focus:outline-none focus:ring-2 focus:ring-primary/20"
              />
              <button
            ...
            <div className="flex items-center gap-2 relative">
              <input
                ...
                readOnly
                className="w-full bg-surface-container-high border border-outline-variant/30 rounded-xl px-4 py-3 text-body-md text-on-surface font-mono text-sm focus:outline-none pr-20"
              />
        ...
        <div>
          ...
          <div className="space-y-2 mb-4">
            {relays.map((relay) => (
              <div key={relay} className="flex items-center justify-between bg-surface-container-high border border-outline-variant/30 rounded-xl px-4 py-3">
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 min-w-0 bg-surface-container-high border border-outline-variant/30 rounded-xl px-4 py-3 text-body-md text-on-surface focus:outline-none focus:border-primary/50"
            />
            <button
