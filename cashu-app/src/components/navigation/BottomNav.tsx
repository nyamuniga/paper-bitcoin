...
export const BottomNav = () => {
  ...
  const isActive = (path: string) => location.pathname === path ? 'text-primary' : 'text-on-surface-variant opacity-60';

  return (
    <nav className="md:hidden bg-surface/80 docked full-width bottom-0 rounded-t-xl backdrop-blur-xl border-t border-outline-variant shadow-[0_-4px_16px_rgba(0,0,0,0.3)] fixed left-0 w-full z-50 flex justify-around items-center px-4 pb-6 pt-3">
      <Link to="/" className={`flex flex-col items-center justify-center relative hover:opacity-100 transition-opacity active:scale-90 transition-transform duration-150 group ${isActive('/')}`}>
        {location.pathname === '/' && <div className="absolute -bottom-1 w-1 h-1 bg-primary rounded-full shadow-[0_0_8px_rgba(158,124,56,0.6)]" />}
      ...
      <Link to="/history" className={`flex flex-col items-center justify-center relative hover:opacity-100 transition-opacity active:scale-90 transition-transform duration-150 group ${isActive('/history')}`}>
        {location.pathname === '/history' && <div className="absolute -bottom-1 w-1 h-1 bg-primary rounded-full shadow-[0_0_8px_rgba(158,124,56,0.6)]" />}
      ...
      <Link to="/scan" className="flex flex-col items-center justify-center -mt-8 relative group">
        <div className="bg-primary w-14 h-14 rounded-full flex items-center justify-center shadow-[0_4px_20px_rgba(158,124,56,0.3)] group-hover:scale-105 transition-transform border-4 border-surface">
      ...
      <Link to="/issue" className={`flex flex-col items-center justify-center relative hover:opacity-100 transition-opacity active:scale-90 transition-transform duration-150 group ${isActive('/issue')}`}>
        {location.pathname === '/issue' && <div className="absolute -bottom-1 w-1 h-1 bg-primary rounded-full shadow-[0_0_8px_rgba(158,124,56,0.6)]" />}
      ...
      <Link to="/settings" className={`flex flex-col items-center justify-center relative hover:opacity-100 transition-opacity active:scale-90 transition-transform duration-150 group ${isActive('/settings')}`}>
        {location.pathname === '/settings' && <div className="absolute -bottom-1 w-1 h-1 bg-primary rounded-full shadow-[0_0_8px_rgba(158,124,56,0.6)]" />}
